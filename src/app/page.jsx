...
export default function HomePage() {
  ...
  // Remove the automatic redirect to /app for authenticated users
  // This allows users to see the home page even when logged in
        ...
        <div className="text-center">
          ...
          <div className="max-w-md mx-auto mb-16">
            <div className="flex shadow-lg rounded-lg overflow-hidden">
              ...
              <button
                onClick={openEmailModal}
                className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors"
              >
                Get started now
              </button>
            </div>
          ...
          {/* Add a direct navigation button to /app */}
          <div className="mb-8">
            <button
              onClick={() => navigate("/app")}
              className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition shadow-md hover:shadow-lg"
            >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 relative">
            ...
            <p className="text-gray-700 mb-6">
              Join our mailing list to receive updates about Veltrian's
              progress.
            </p>
